...
/** @struct FitterWithRootVariant

*
*
*/

struct FitterWithRootVariant final : 
...
{
    FitterWithRootVariant(const std::string& name, ISvcLocator* svcLoc) : 
                                                        ...
                                                        const edm4hep::TrackerHitSimTrackerHitLinkCollection& wrapperD_links) const override 
    {
        ...
        TGeoManager::Import("/eos/user/a/adevita/saveSpace/IDEA_fitValidation/TGeo_IDEA.root");
...
DECLARE_COMPONENT(FitterWithRootVariant)
