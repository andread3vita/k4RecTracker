...
struct GGTF_tracking_dbscan_noSim final : 
...
{
    GGTF_tracking_dbscan_noSim(const std::string& name, ISvcLocator* svcLoc) : 
...
DECLARE_COMPONENT(GGTF_tracking_dbscan_noSim)
