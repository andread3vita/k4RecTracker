// #include "GGTF_tracking_dbscan_alg.hpp"
// #include "dbscan.hpp"
// #include <iostream>
// #include <sstream>
// #include <vector>
...
// DECLARE_COMPONENT(GGTF_tracking_dbscan_alg)

// GGTF_tracking_dbscan_alg::GGTF_tracking_dbscan_alg(const std::string& aName, ISvcLocator* aSvcLoc) : Gaudi::Algorithm(aName, aSvcLoc) {
...
// GGTF_tracking_dbscan_alg::~GGTF_tracking_dbscan_alg() {}

// StatusCode GGTF_tracking_dbscan_alg::initialize() { 
...
// StatusCode GGTF_tracking_dbscan_alg::execute(const EventContext&) const {
...
// StatusCode GGTF_tracking_dbscan_alg::finalize() { return StatusCode::SUCCESS; }
