#include "GenFitter_evaluation_dbscan.h"
#include "dbscan.hpp"
#include <iostream>
#include <sstream>
#include <vector>
...
DECLARE_COMPONENT(GenFitter_eval_dbscan)

GenFitter_eval_dbscan::GenFitter_eval_dbscan(const std::string& aName, ISvcLocator* aSvcLoc) : Gaudi::Algorithm(aName, aSvcLoc) {
...
GenFitter_eval_dbscan::~GenFitter_eval_dbscan() {}

StatusCode GenFitter_eval_dbscan::initialize() { 
...
StatusCode GenFitter_eval_dbscan::execute(const EventContext&) const {
...
StatusCode GenFitter_eval_dbscan::finalize() { return StatusCode::SUCCESS; }
