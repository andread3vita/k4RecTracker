#include "VTXdigitizer_IDEAv2.h"

DECLARE_COMPONENT(VTXdigitizer_IDEAv2)

VTXdigitizer_IDEAv2::VTXdigitizer_IDEAv2(const std::string& aName, ISvcLocator* aSvcLoc)
    : Gaudi::Algorithm(aName, aSvcLoc), m_geoSvc("GeoSvc", "VTXdigitizer_IDEAv2") {
...
VTXdigitizer_IDEAv2::~VTXdigitizer_IDEAv2() {}

StatusCode VTXdigitizer_IDEAv2::initialize() {
...
StatusCode VTXdigitizer_IDEAv2::execute(const EventContext&) const {
...
StatusCode VTXdigitizer_IDEAv2::finalize() { return StatusCode::SUCCESS; }