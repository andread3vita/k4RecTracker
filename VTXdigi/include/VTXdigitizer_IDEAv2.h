...
class VTXdigitizer_IDEAv2 : public Gaudi::Algorithm {
public:
  explicit VTXdigitizer_IDEAv2(const std::string&, ISvcLocator*);
  virtual ~VTXdigitizer_IDEAv2();
  /**  Initialize.
   *   @return status code
   */
